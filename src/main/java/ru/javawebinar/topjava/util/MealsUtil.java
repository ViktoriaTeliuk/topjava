...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак второго юзера", 500),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед второго юзера", 1000),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин второго юзера", 500),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак второго юзера", 1000),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед второго юзера", 500),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин второго юзера", 510)
    );
