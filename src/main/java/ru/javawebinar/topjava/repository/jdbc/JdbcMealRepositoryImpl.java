...
public abstract class JdbcMealRepositoryImpl implements MealRepository {
    ...
    @Autowired
    public void setMealRepositoryImplParams(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    abstract protected <T> T getNeededTypeDate(LocalDateTime dt);
